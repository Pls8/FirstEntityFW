...
{
    /// <inheritdoc />
    public partial class FixCascadeDeleteTransactionTBV : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LibraryBranches", x => x.BranchId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StaffBranchId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_LibraryStaff", x => x.StaffId);
                    table.ForeignKey(
                        name: "FK_LibraryStaff_LibraryBranches_StaffBranchId",
                        column: x => x.StaffBranchId,
                        principalTable: "LibraryBranches",
                        principalColumn: "BranchId",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    BookCategorytId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    BookId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BookCategories", x => x.BookCategorytId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Transactions_LibraryStaff_StaffId",
                        column: x => x.StaffId,
                        principalTable: "LibraryStaff",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LibraryStaff_StaffBranchId",
                table: "LibraryStaff",
